...
const StarBackground = () => {
  ...
  // ⚠️ 关键修改：使用 style 内联样式替代Tailwind 类名
  // 确保在 Vercel 生产环境中样式绝对不会丢失
  return (
    <canvas 
      ref={canvasRef} 
      style={{
...
// ⚠️ 关键修正：使用 style 对象而非 className，确保输入框圆角和透明度样式优先级最高
const inputStyle = {
  height: '60px',
...
// ⚠️ 关键修正：日期三列专用样式 (无黑边，居中对齐)
const smallInputStyle = {
  ...inputStyle,
  height: '56px',
  paddingLeft: '0', // 清除左边距，完全居中
  display: 'flex',
  alignItems: 'center',
...
// ✨ 下拉菜单样式优化：
// 1. rounded-lg: 圆角改小，防止遮挡文字 (原 rounded-2xl)
// 2. border-white/10: 确保是微光白边，而不是默认黑/白
...
// ✨ 选项样式：确保文字居中 (justify-center text-center)
...
function ResultView({ data, onReset }: { data: any, onReset: () => void }) {
  ...
  return (
    <div className="w-full flex flex-col animate-in slide-in-from-bottom-10 duration-700 pb-20 relative z-10">
...
export default function Home() {
  ...
  const renderInput = () => (
    <div className="w-full flex flex-col animate-in fade-in relative z-10">
                ...
                <div className="flex gap-3">
                    <div className="flex-1">
                      <Select onValueChange={setSelYear}>
                          <SelectTrigger className="w-full" style={smallInputStyle}><SelectValue placeholder="Year" /></SelectTrigger>
                    ...
                    <div className="flex-1">
                      <Select onValueChange={setSelMonth}>
                          <SelectTrigger className="w-full" style={smallInputStyle}><SelectValue placeholder="Mon" /></SelectTrigger>
                          <SelectContent className={`${dropdownContentClass} max-h-[300px]`}>
                    ...
                    <div className="flex-1">
                      <Select onValueChange={setSelDay}>
                          <SelectTrigger className="w-full" style={smallInputStyle}><SelectValue placeholder="Day" /></SelectTrigger>
                          <SelectContent className={`${dropdownContentClass} max-h-[300px]`}>
              ...
              <div className="pt-6 border-t border-white/10">
                 <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-white/90 font-medium tracking-wider">加入对方信息，解锁双人磁场</span>
                    </div>
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0f0c29] font-sans text-white overflow-hidden selection:bg-[#D4AF37]/30 py-20 relative">
      <StarBackground />
